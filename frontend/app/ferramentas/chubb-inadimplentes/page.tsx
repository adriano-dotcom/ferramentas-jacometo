...
export default function ChubbInadimplentesPage() {
  ...
  async function executar() {
    ...
    try {
      ...
      setJob({ id: data.jobId, status: 'executando', progresso: 0, total: 4, resultados: [], erro: null })
    } catch (e: any) {
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 540, margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-2)', marginBottom: '1.5rem', lineHeight: 1.5 }}>
          O sistema entra no portal ChubbNet, extrai todas as parcelas pendentes de pagamento e envia o relatório por email.
        </p>
          ...
          <>
            ...
            <div style={{ background: 'var(--surface)', border: '0.5px solid var(--border)', borderRadius: 12, overflow: 'hidden', marginBottom: 14 }}>
              ...
              <div style={{ padding: '12px 14px', borderBottom: '0.5px solid var(--border)' }}>
                ...
                <div style={{ fontSize: 13, fontWeight: 500 }}>ChubbNet — sso.chubbnet.com</div>
                <div style={{ fontSize: 12, color: 'var(--text-2)', marginTop: 2 }}>Serviços → Financeiro → Cobrança</div>
              </div>

              {/* Filtros */}
              <div style={{ padding: '12px 14px', borderBottom: '0.5px solid var(--border)' }}>
                <div style={{ fontSize: 11, color: 'var(--text-3)', marginBottom: 6 }}>Filtros aplicados automaticamente</div>
              ...
              <div style={{ padding: '12px 14px', borderBottom: '0.5px solid var(--border)' }}>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  {[
                    { ramo: 'Ramo 54', desc: 'RC Transportes' },
                    { ramo: 'Ramo 55', desc: 'RCF Desvio de Carga' },
                  ].map(r => (
              ...
              <div style={{ padding: '12px 14px' }}>
                ...
                <div style={{ fontSize: 13 }}>Email + CSV para <span style={{ fontWeight: 500 }}>jacometo@jacometo.com.br</span></div>
              </div>
            </div>
            ...
            <div style={{ padding: '9px 12px', background: '#FAEEDA', border: '0.5px solid #BA7517', borderRadius: 8, fontSize: 12, color: '#633806', marginBottom: 14 }}>
              ⚠️ Usar <strong>sso.chubbnet.com</strong> — não confundir com brportal.chubb.com (iBroker, sem financeiro).
            </div>
