...
const FERRAMENTAS = [
  ...
  {
    slug: 'giacomet-tokio-inadimplentes',
    nome: 'Giacomet — Tokio Marine',
    descricao: 'Clientes Inadimplentes · Giacomet',
    responsavel: 'Giacomet',
    seguradora: 'Tokio Marine',
    tipo: 'automatico',
    status: 'ativo',
  ...
  {
    slug: 'giacomet-axa-inadimplentes',
    nome: 'Giacomet — AXA',
    descricao: 'Pagamento e Boletos · Parcelas em Atraso · Giacomet',
    responsavel: 'Giacomet',
    seguradora: 'AXA',
    tipo: 'automatico',
    status: 'ativo',
  ...
  {
    slug: 'giacomet-chubb-inadimplentes',
    nome: 'Giacomet — Chubb',
    descricao: 'ChubbNet · Cobrança · Giacomet',
    responsavel: 'Giacomet',
    seguradora: 'Chubb',
    tipo: 'automatico',
    status: 'ativo',
  ...
  {
    slug: 'giacomet-sompo-inadimplentes',
    nome: 'Giacomet — Sompo',
    descricao: 'Consultar Parcelas · Situação Pendente · Giacomet',
    responsavel: 'Giacomet',
    seguradora: 'Sompo',
    tipo: 'automatico',
    status: 'ativo',
  ...
  {
    slug: 'giacomet-essor-inadimplentes',
    nome: 'Giacomet — Essor',
    descricao: 'Parcelas Pendentes · Giacomet',
    responsavel: 'Giacomet',
    seguradora: 'Essor',
    tipo: 'automatico',
    status: 'ativo',
  ...
  {
    slug: 'giacomet-porto-seguro-inadimplentes',
    nome: 'Giacomet — Porto Seguro',
    descricao: 'Corretor Online · Parcelas vencidas · Giacomet',
    responsavel: 'Giacomet',
    seguradora: 'Porto Seguro',
    tipo: 'automatico',
    status: 'ativo',
